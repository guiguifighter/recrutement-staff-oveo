...
<div class="container">
    ...
    <div class="header-sticky">
        ...
        <div style="display: flex; gap: 8px; align-items: center;">
            <button id="btn-save" class="btn-glass" onclick="saveToStorage()">💾 Enregistrer</button>
            <button onclick="toggleAdmin()" style="background:#222; border:1px solid var(--blue); color:var(--blue); border-radius:5px; cursor:pointer; padding:8px;">⚙️ CONFIG</button>
    ...
    <div class="section">
        <h2>❌ OBSERVATIONS</h2>
        <textarea id="obs" style="width:100%; background:#000; color:#fff; border:1px solid #444; padding:10px; border-radius:8px;" rows="4" placeholder="Détails supplémentaires..."></textarea>
    </div>

    <div class="actions">
        <button class="btn-gen" onclick="generateReport()">GÉNÉRER LE BILAN</button>
...
<div id="modal-overlay">
    <div class="modal">
        ...
        <div id="modal-inputs">
            ...
            <input type="text" id="modal-a" placeholder="Réponse attendue">
        </div>
...
<script>
    let surveyData = JSON.parse(localStorage.getItem('oveo_master_config')) || [
        { title: "PARTIE 1 : ICEBREAKER", qs: [
            {q: "Qui es-tu sur le serveur ?", a: "Vérification identité/ancienneté"},
            {q: "C'est quoi ton moment préféré ?", a: "Analyse du style de jeu"},
            {q: "Solo ou Créateur ?", a: "Profil psychologique"},
            {q: "Si tu pouvais changer UNE chose ?", a: "Sens critique"},
            {q: "Joueur énervant ?", a: "Self-control"}
        ]},
        { title: "🏛️ Le Maire et la Politique", qs: [
            {q: "Règlement > lois du maire ?", a: "Vrai."},
    ...
    function saveToStorage() {
        ...
        alert("Configuration enregistrée et mode édition désactivé.");
    }
        ...
        surveyData.forEach((sec, sIdx) => {
            ...
            secDiv.innerHTML = `
                ...
                <div class="admin-controls">
                    <button class="btn-admin btn-move" onclick="moveItem('SEC', ${sIdx}, null, -1)">▲</button>
                    <button class="btn-admin btn-move" onclick="moveItem('SEC', ${sIdx}, null, 1)">▼</button>
            ...
            sec.qs.forEach((qObj, qIdx) => {
                ...
                qBox.innerHTML = `
                    ...
                    <span class="ans-hint">Réponse : ${qObj.a}</span>
                    <div class="admin-controls">
                        <button class="btn-admin btn-move" onclick="moveItem('Q', ${sIdx}, ${qIdx}, -1)">▲</button>
                        <button class="btn-admin btn-move" onclick="moveItem('Q', ${sIdx}, ${qIdx}, 1)">▼</button>
    ...
    function updateScore() {
        ...
        st.innerText = score >= 37 ? "ACCEPTÉ" : "REFUSÉ";
    ...
    function copyReport() { navigator.clipboard.writeText(document.getElementById('report').innerText); alert("Copié !"); }
